          ...
          this.buildSvgCanvas(),
            ...
            'none' !== this.togglecontent &&
              ...
              this.dom.el === document.querySelector('.js-btn-selected') &&
                ((o.contentToggle.activeButton = this), this.setActiveButton()))
        }
        addEvents() {
        ...
        constructor() {
          w(this, 'onAssetsProgress', ({ percent: e }) => {
              ...
              window.clearTimeout(this.timeout),
                ...
                l.ZP.timeline({
                  ...
                  .to(
                    ...
                    {
                      scale: 1,
                      ease: v.tQ.easeOut.config(0.5, 0.3),
                    },
                    0.1
                  )
            }),
            ...
            w(this, 'onPointerMove', () => {
              ;(this.mouse.x =
                ((o.mouse.x - this.btnCenterX) / o.window.w) * 2),
                (this.mouse.y =
          ...
          return this.getDependency('texture', i.index).then(function (n) {
            if (
              ...
              if (e) {
                ...
                ;(n = o.extensions[E.KHR_TEXTURE_TRANSFORM].extendTexture(
                  n,
                  e
                )),
              ...
              this.allowControl &&
                ...
                this.itemOpen ||
                  ...
                  (this.draggingTl = l.ZP.timeline({
                    ...
                    .to(
                      this.edgeWarp.uniforms.u_scale,
                      {
                        value: 1.2,
                      },
                      0
        ...
        showItem() {
          ...
          l.ZP.set(this.details.position, {
            ...
            (this.openTimeline = l.ZP.timeline({
              ...
              .to(
                this.scanlines.uniforms.u_strength,
                {
                  value: 1,
                },
                0
      ...
      class ws {
        ...
        buildGrass() {
          ...
          ;(this.grassSharedUniforms = {
            ...
            lightPos: {
              value: new s.Pa4(-0.26, -1.06, -0.22),
            },
          }),
          ...
          this.particles = new s.SPe(
            ...
            new s.jyz({
              ...
              uniforms: {
                ...
                u_lightPos: {
                  value: new s.Pa4(0.79, 0.24, 0.63),
                },
              },
              transparent: !0,
              depthWrite: !1,
          ...
          xo(this, 'isAnimating', !1),
            ...
            xo(this, 'handleFilterClick', e => {
              ...
              const project = window.projects.find(
                p =>
                  p.project.title.toLowerCase().replace(/\s/g, '-') === filter
              )
              if (project) {
                this.initModal(project)
              } else {
        ...
        buildTransition() {
          this.transitionTimeline = v.ZP.timeline({
            ...
            .to(
              this.params,
              {
                footerContentTweenProgress: 0.2,
              },
              0
            )
        }
          ...
          if (o.Project.transitioning)
            (this.loaderVisible = !1),
              ...
              v.ZP.timeline({
                ...
                .to(
                  o.Project.scrollProgress.scale,
                  {
                    x: 0,
                  },
                  0
